...
export default function Register(){
    return(
        <div>
            <Header></Header>
            <section class="bg-gray-100 font-open w-full h-screen">
                <div className="flex flex-col item-center justify-center">
                    <img src={logo} className="w-40 h-36 items-center justify-center mx-auto" alt="" />
                    <div className="w-96 pr-4 pt-4 pb-4 h-auto border-2 border-orange-400 border-opacity-20 hover:border-opacity-70 duration-200 bg-white rounded-lg shadow-lg flex flex-col item-center justify-center mx-auto">
                        <h1 className="text-center mt-5 font-bold uppercase mb-5">Kayıt ol</h1>
                        ...
                        <button className="bg-orange-400 border h-10 mb-5 mt-5 border-orange-400 text-white px-8 mx-auto rounded-lg hover:bg-orange-300  transition duration-200">Kayıt Ol</button>
